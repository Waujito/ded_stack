...
LIBSRC := src/pvector.cpp src/gdb_assertions.cpp src/data_structure.cpp src/hash.cpp
...
CPPSRC := #src/stack.cpp
CPPOBJ := $(CPPSRC:%.cpp=$(BUILD_DIR)/%.o)
APP := #$(BUILD_DIR)/stack_st
